...
\fancyfoot{}
\cfoot{
  This is a copy generated on \textbf{\today}. 
  Check out the latest copy at \href{https://gauk.as/cv}{\textbf{gauk.as/cv}}!
}
...
\section{Selected Works}
    \resumeSubHeadingListStart
      \resumeProjectHeading
      {\href{https://github.com/refraction-networking/utls}{\textbf{uTLS}} $|$ \emph{Golang}}{}
      \resumeItemListStart
      \resumeItem{Fork of the Go standard TLS library, providing low-level access to the ClientHello for mimicry purposes.}
      \resumeItemListEnd

      \resumeProjectHeading
      {\href{https://github.com/Gaukas/seed2sdp}{\textbf{Seed2SDP}} $|$ \emph{Golang}}{}
      \resumeItemListStart
      \resumeItem{A design to minimize data exchange before a WebRTC PeerConnection could be negotiated.}
      \resumeItemListEnd

      \resumeProjectHeading
      {\href{https://github.com/Gaukas/transportc}{\textbf{TranspoRTC}} $|$ \emph{Golang}}{}
      \resumeItemListStart
